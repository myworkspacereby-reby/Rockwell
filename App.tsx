    ...
    <div className="relative min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-transparent py-4">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#home" className="flex items-center">
            <img 
              src="/src/assets/images/rockwell_logo_white_1779096188911.png" 
              alt="Rockwell" 
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/src/assets/images/hero_workspace_background_1779091807771.png" 
            alt="Workspace" 
      ...
      <footer className="pt-24 border-t border-white/5 text-center px-6">
        ...
        <p className="text-[9px] uppercase tracking-[4px] opacity-20">
          © 2026 Internal Strategy • confidential • raver.ai
        </p>
      </footer>
    </div>
  </div>
